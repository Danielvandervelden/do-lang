---
name: <<DO:AGENT_PREFIX>>-executioner
...
Spawned after `<<DO:AGENT_PREFIX>>-plan-reviewer` passes and user approves execution.
...
Also load any clarifications from <<DO:AGENT_PREFIX>>-griller if present.
