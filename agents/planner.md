...
Your job: Create a complete, actionable plan that <<DO:AGENT_PREFIX>>-executioner can follow.
...
```bash
node <<DO:SCRIPTS_PATH>>/load-task-context.cjs "<task-description>"
```
