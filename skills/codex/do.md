...
- "check best practices for this agent" → `/do:optimise agents/codex-verifier.md`
- "optimise this project" → `/do:optimise`
- "audit this script" → `/do:optimise skills/do/scripts/council-invoke.cjs`
- "are there improvements for this skill?" → `/do:optimise skills/codex/task.md`
...
This path is guaranteed to exist for every consumer project after `npm install -g @danielvandervelden/do-lang` (the postinstall step copies `skills/do/scripts/` to `~/.codex/skills/do/scripts/`).
