...
This reference file is loaded by `skills/codex/project.md` `complete`. It validates preconditions, renders `completion-summary.md`, advances project state, and archives the project folder.
