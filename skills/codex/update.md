...
```
do skills installed to /Users/<user>/.codex/skills/do
...
ls ~/.codex/agents/codex-*.md 2>/dev/null | head -1 | grep -q . && echo "agents_ok" || echo "agents_missing"
```
