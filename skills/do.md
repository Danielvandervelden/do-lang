...
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/do:task`     | <<DO:AGENT_PREFIX>>-planner, <<DO:AGENT_PREFIX>>-plan-reviewer, <<DO:AGENT_PREFIX>>-council-reviewer, <<DO:AGENT_PREFIX>>-griller, <<DO:AGENT_PREFIX>>-executioner, <<DO:AGENT_PREFIX>>-code-reviewer, <<DO:AGENT_PREFIX>>-verifier |
| `/do:continue` | <<DO:AGENT_PREFIX>>-planner, <<DO:AGENT_PREFIX>>-plan-reviewer, <<DO:AGENT_PREFIX>>-council-reviewer, <<DO:AGENT_PREFIX>>-griller, <<DO:AGENT_PREFIX>>-executioner, <<DO:AGENT_PREFIX>>-code-reviewer, <<DO:AGENT_PREFIX>>-verifier |
| `/do:fast`     | <<DO:AGENT_PREFIX>>-executioner, <<DO:AGENT_PREFIX>>-code-reviewer                                                                                                                                                                  |
| `/do:quick`    | <<DO:AGENT_PREFIX>>-council-reviewer                                                                                                                                                                                                |
| `/do:debug`    | <<DO:AGENT_PREFIX>>-debugger                                                                                                                                                                                                        |
| `/do:project`  | <<DO:AGENT_PREFIX>>-planner, <<DO:AGENT_PREFIX>>-plan-reviewer, <<DO:AGENT_PREFIX>>-council-reviewer, <<DO:AGENT_PREFIX>>-griller, <<DO:AGENT_PREFIX>>-executioner, <<DO:AGENT_PREFIX>>-code-reviewer, <<DO:AGENT_PREFIX>>-verifier |
...
- "check best practices for this agent" → `/do:optimise agents/verifier.md`
- "optimise this project" → `/do:optimise`
- "audit this script" → `/do:optimise skills/scripts/council-invoke.cjs`
- "are there improvements for this skill?" → `/do:optimise skills/task.md`
...
```bash
node <<DO:SCRIPTS_PATH>>/<name>.cjs
```

This path is guaranteed to exist for every consumer project after `npm install -g @danielvandervelden/do-lang` (the postinstall step copies `skills/scripts/` to `<<DO:SCRIPTS_PATH>>/`).
