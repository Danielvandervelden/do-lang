...
Reference `skills/do/references/delivery-contract.md` for the exact schema.
Reference `skills/do/scripts/validate-delivery-contract.cjs` for the validator the entry command should optionally call.
...
**The schema (from skills/do/references/delivery-contract.md):**
...
**The validator (skills/do/scripts/validate-delivery-contract.cjs):**
const { validateDeliveryContract, applyDefaults, parseDeliveryArg } = require('skills/do/scripts/validate-delivery-contract.cjs');
