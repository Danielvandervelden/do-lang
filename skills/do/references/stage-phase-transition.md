...
Read the next phase's `phase.md` confidence score. If below `project_intake_threshold`, spawn `do-griller` (pass the project threshold explicitly — `do-griller`'s default is task-safe):
