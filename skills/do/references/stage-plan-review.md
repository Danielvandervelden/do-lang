...
```bash
node ~/.claude/commands/do/scripts/council-gate.cjs planning
```
...
Load and follow `@references/classify-findings.md`. The self-review output comes from do-plan-reviewer (CONCERNS or RETHINK response).
