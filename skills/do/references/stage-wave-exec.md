...
This reference file is loaded by `skills/do/project.md` `wave next` after `stage-wave-plan-review.md` returns APPROVED. It spawns `do-executioner` against the wave's `wave.md` file.
...
- **BLOCKED**: Surface blocker to user:
  ...
  3. Mark out of scope (edit wave.md scope field manually)
