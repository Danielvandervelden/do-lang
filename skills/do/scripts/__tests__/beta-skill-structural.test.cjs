 ...
 *
 * Run: node --test skills/do/scripts/__tests__/beta-skill-structural.test.cjs
 */
...
const PROJECT_SKILL = path.join(ROOT, 'skills', 'do', 'project.md');
...
describe('β skill file: skills/do/project.md', () => {
  let content;
  before(() => { content = read(PROJECT_SKILL); });
