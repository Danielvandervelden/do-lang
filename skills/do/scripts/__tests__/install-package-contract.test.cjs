...
describe("package install contract", () => {
  it("packed postinstall creates working Claude commands and Codex registered skills", () => {
    ...
    try {
      ...
      assertFileExists(path.join(packageDir, "skills", "do", "project.md"));
      assertFileExists(path.join(packageDir, "skills", "codex", "project.md"));
      assertFileExists(path.join(packageDir, "agents", "do-executioner.md"));
      assertFileExists(path.join(packageDir, "agents", "codex-executioner.md"));
