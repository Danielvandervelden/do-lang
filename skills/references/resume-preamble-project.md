...
The `modified_files[]` frontmatter array is authoritative (written by <<DO:AGENT_PREFIX>>-executioner at end of execution); the `## Execution Log` body section is human-readable and used as supplemental context.
