...
<!--
Populated during implementation (<<DO:AGENT_PREFIX>>-executioner writes here).
...
<!--
Populated during verification (<<DO:AGENT_PREFIX>>-verifier writes here).
...
<!--
Populated by <<DO:AGENT_PREFIX>>-griller during per-wave confidence rescue when confidence is below threshold.
Format:
### Q1: <question>
<answer>
-->
...
<!--
Populated by <<DO:AGENT_PREFIX>>-plan-reviewer and <<DO:AGENT_PREFIX>>-code-reviewer.
-->
