...
This path is guaranteed to exist for every consumer project after `npm install -g @danielvandervelden/do-lang` (the postinstall step copies `skills/scripts/` to `~/.claude/commands/do/scripts/`).
