...
- `/do:optimise agents/verifier.md` — audit a single agent file
- `/do:optimise skills/scan.md --effort high` — deep audit of a skill file
- `/do:optimise skills/scripts/council-invoke.cjs` — audit a CJS script
...
node ~/.claude/commands/do/scripts/optimise-target.cjs "<target_path>" --effort <effort>

# Target only (medium effort):
node ~/.claude/commands/do/scripts/optimise-target.cjs "<target_path>"

# Effort only (project mode):
node ~/.claude/commands/do/scripts/optimise-target.cjs --effort <effort>

# No args (project mode, medium effort):
node ~/.claude/commands/do/scripts/optimise-target.cjs
```
