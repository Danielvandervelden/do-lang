...
**Orchestrator makes the change directly** using Read/Edit/Write in the main conversation. No `do-executioner` spawn.
...
Read the round-1 findings from `quick_council_r1`. Apply the requested changes directly via Read/Edit/Write in the main conversation. Do NOT spawn do-executioner.
