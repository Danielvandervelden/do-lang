...
<!--
Populated by codex-griller during per-phase re-grill when confidence is below threshold.
Format:
### Q1: <question>
<answer>
-->
...
<!--
Populated by codex-plan-reviewer and codex-council-reviewer during phase-plan review.
-->
