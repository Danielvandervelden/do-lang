...
This reference file is loaded by `skills/project.md` `wave next` after `stage-wave-plan-review.md` returns APPROVED. It spawns `codex-executioner` against the wave's `wave.md` file.
