...
This reference file is loaded by `skills/project.md` `wave next` after `stage-wave-code-review.md` returns VERIFIED. It spawns `codex-verifier` against the wave's `wave.md` file and handles project-aware failure paths.
